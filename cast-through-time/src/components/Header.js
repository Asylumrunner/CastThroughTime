function Header() {
    return (<div className="flex-col justify-items-center items-center pb-8">
        ...
        come up in any given game of <i>Magic</i>, giving you what you need to confidently hop into a game of modern <i>Magic</i> and have a good baseline from which to start playing, handling
        more specific cards, keywords, and interactions when they come up.</p>
    </div>)
}
